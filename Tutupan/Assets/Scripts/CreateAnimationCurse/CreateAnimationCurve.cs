...
public class CreateAnimationCurve : MonoBehaviour
{
    ...
    public AnimationClip CreateAnimation(List<PhonemeData> phonemeData, VisemeGroupInfo visemeGroup)
    {
        ...
        clip.SetCurve("Face", typeof(SkinnedMeshRenderer), "blendShape." + "Fcl_MTH_A", curveA);
        clip.SetCurve("Face", typeof(SkinnedMeshRenderer), "blendShape." + "Fcl_MTH_I", curveI);
        clip.SetCurve("Face", typeof(SkinnedMeshRenderer), "blendShape." + "Fcl_MTH_U", curveU);
        clip.SetCurve("Face", typeof(SkinnedMeshRenderer), "blendShape." + "Fcl_MTH_E", curveE);
        clip.SetCurve("Face", typeof(SkinnedMeshRenderer), "blendShape." + "Fcl_MTH_O", curveO);
        return clip;
